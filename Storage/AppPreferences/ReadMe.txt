This sample project demonstrates how to use Solar2D's preference APIs to read, write, and delete an app's custom settings to/from local storage. These settings will persist after the app exits, to be read the next time the app starts up.
